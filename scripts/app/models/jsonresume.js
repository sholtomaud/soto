module.exports = {
    ...
    "work": [
        {
            ...
            "endDate": "2014-07-01",
            "summary": "The role with Arrow presented an very interesting experiment in adapting the Hydstra legacy system to an unconventional usage. Hydstra is largely a surface water system. At Arrow we attempted to modify Hydstra to accommodate hydrogeological data used for monitoring the compliance of Coal Seam Gas operations. Ultimately the differences in Data Models and release cycle of the Hydstra system presented significant ongoing challenges to the project. These challenges motivated me to undertake my PhD research into the application of BigData systems to alleviate the problem."
        },{
    ...
    "skills": [
        {
            ...
            "level": "Somewhere between intermediate and advanced depending on what needs to be done",
            "keywords": [
                "Node.js",
                "Stylus",
                "MongoDB",
    ...
    "references": [
        {
            "name": "Please contact me for names and contact details"
        }
    ]
}