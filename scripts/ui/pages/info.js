    ...
    return fastn('div', {class: 'infoPage'}, 
            ...
            fastn('div',{class: 'appInfo'}, 
                ...
                fastn('div',{class:'appDetails'},  'I wrote this app using a couple of very cool javaScript tools - the javaScript tool ', 
                    ...
                    ' in particular is woth highlighting. I\'ve been using fastn instead of Angular, or any of the other frameworks. Basically it means all you need is javaScript, fastn and css. Along with fastn, there is a bit of ',
                    fastn('a',{
